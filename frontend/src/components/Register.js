  ...
  return (
    <>
      <style>{`
        ...
        .auth-sub { color: #6d6a8a; font-size: 0.9rem; margin-bottom: 1.5rem; }
        .perks {
          display: flex;
          gap: 0.75rem;
        ...
        .perk-icon { font-size: 1.2rem; display: block; margin-bottom: 0.25rem; }
        .auth-label {
          display: block;
          font-size: 0.78rem;
          font-weight: 600;
      ...
      <div className="auth-page">
        <div className="auth-card">
          ...
          <h2 className="auth-title">Create your<br/>account</h2>
          <p className="auth-sub">Start tracking in under 60 seconds.</p>
          <div className="perks">
            <div className="perk"><span className="perk-icon">📊</span>Analytics</div>
            <div className="perk"><span className="perk-icon">🔐</span>Secure</div>
            <div className="perk"><span className="perk-icon">⚡</span>Instant</div>
          </div>
